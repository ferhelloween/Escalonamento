		...
		<fieldset class="borda-form" style="width: 90%;">
			<form name="regEscalonamento" method="POST">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="Modelo" name="nModelo" placeholder="Modelo">
						</div>	
					</div>
					...
					<div class="col-sm-3">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="Host" name="nHost" placeholder="Host">
						</div>	
					</div>
					...
					<div class="col-sm-3">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="Localidade" name="nLocalidade" placeholder="Localidade">
						</div>	
					</div>	
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="Servico" name="nServico" placeholder="Serviço">
						</div>	
					</div>	
				...
				<button type="submit" 
						...
						formaction="../CONTROLLERS/FornecedoresController.php?opcao=Registrar"
						formtarget="_self"
						>
