	 ...
	 $queryPorId = "
				SELECT [id] as cod ,[tipo] ,[empresa] ,[marca]
 				,[num_serie] ,[patrimonio] ,[usuario] ,[fone]
      			...
      			,[user_alt]  FROM [Inventario].[dbo].[Tb_inv_CGR] WHERE [id] = $idd
	";  
		...
		<form name="regInventario" method="POST">		
				...
				<div class="col-sm-6">	
					...
					<div class="col-sm-4">	
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="Patrimonio" value="<?=$lista['patrimonio'];?>" name="nPatrimonio" >
						</div>
					</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" id="Serie" name="nSerie" value="<?=$lista['num_serie'];?>" placeholder="Nº de Série">
					</div>	
				</div>
				...
				<div class="col-sm-4">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control" id="Marca" name="nMarca" value="<?=$lista['marca'];?>" placeholder="Marca do equipamento">
					</div>	
				</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-user"></i></span>
						<input type="text" class="form-control" id="Usuario" name="nUsuario" value="<?=$lista['usuario'];?>" placeholder="Usuário do equipamento">
					</div>	
				</div>
				...
				<div class="col-sm-4">
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-id-card"></i></span>
						<input type="text" class="form-control" id="Telefone" name="nTelefone" value="<?=$lista['fone'];?>" placeholder="(11)9999-9999">
						<script>
				...
				<div class="col-sm-4">
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-address-book"></i></span>
						<input type="text" class="form-control" id="Ponto" name="nPonto" value="<?=$lista['pont_log'];?>" placeholder="Ponto de Instalação">
					</div>	
				</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-user"></i></span>
						<input type="text" class="form-control" id="Hostname" name="nHostname" value="<?=$lista['hostname'];?>" placeholder="Hostname">
					</div>	
				</div>
				...
				<div class="col-sm-4">
					...
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-id-card"></i></span>
						<input type="text" class="form-control" id="Sofware" name="nSofware" value="<?=$lista['software'];?>" placeholder="Programa/Software">
					</div>	
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						...
						<div class="input-group">
							...
							<textarea class="form-control" rows="6" id="Observacao" name="nObservacao" style="resize: none;"><?=$lista['obs1'];?></textarea>
						</div>	
					</div>
				...
				<button type="submit" 
						...
						formaction="../CONTROLLERS/InventarioController.php?opcao=Alterar"
						formtarget="_self"
					>
