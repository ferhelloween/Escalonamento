		...
		<fieldset class="borda-form" style="width: 90%;">
			<form name="regEscalonamento" method="POST">
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">	
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="Funcionario" name="nFuncionario" placeholder="Nome do Funcionário">
						</div>
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-2">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="Matricula" name="nMatricula" placeholder="C000000">
						</div>	
					</div>
					<!--Área-->
					<div class="col-sm-2">
					...
					<div class="col-sm-3">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="Funcao" name="nFuncao" placeholder="Funcao do funcionario">
						</div>	
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-12">
						...
						<div class="input-group">
							...
							<label class="checkbox-inline text-primary"><input type="checkbox" id="fs" name="nEscFs" value="1">Fins de Semana</label> 
							<label class="checkbox-inline text-primary"><input type="checkbox" id="ma" name="nEscMa" value="1">Madrugada</label>
						</div>
					</div>	
				...
				<button type="submit" 
						...
						formaction="../CONTROLLERS/EscalonamentoCaixaController.php?opcao=Registrar" 
						formtarget="_self"
						>
