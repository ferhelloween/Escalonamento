<?php 
	...
	include_once "../MODELS/Conexao.php";
	 ...
	 $queryPorId = "
				SELECT [id],[operadora],[sigla],[nivel],[contato],[funcao],[telefone],[opcao]
    		 ,[celular1],[celular2],[email],[hor_atend],[tpa],[hc],[ot],[obs],[user_alt]
    		 ,[niv_min],[coml]
    		 FROM [Inventario].[dbo].[tb_escalonamento]  WHERE [id] = $idd
	";  
	  ...
	  <script type="text/javascript">
	  		...
	  		$(document).ready(function() { 
	  			...
	  			$.getJSON('../CONTROLLERS/EscalonamentoController.php?opcao=Listar', function(data) { 
	  				if(data.length > 0) { 
	  					var option = '<option value="<?=$lista["operadora"];?>"><?=$lista["operadora"];?></option>'
...
<body>
		<fieldset class="borda-form" style="width: 95%;">
			<form name="regEscalonamento" method="POST">
				...
				<div class="form-group row">
					...
					<div class="col-sm-2">	
						...
						<div class="input-group">
							...
							<input type="number" class="form-control" id="Nivel" name="nNivel" value="<?=$lista['nivel'];?>" placeholder="0-10" min="0" max="10">
						</div>
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="Contato" name="nContato" 
							value="<?=$lista['contato'];?>" placeholder="Nome do Contato">
						</div>	
					</div>
					<!--Função-->
					<div class="col-sm-4">
						...
						<div class="input-group">
							...
							value="<?=$lista['funcao'];?>" placeholder="Função do Contato">
						</div>	
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						...
						<div class="input-group">
							...
							value="<?=$lista['telefone'];?>"  placeholder="(99)1111-1111" 
							maxlength="13" >
							<script>
					...
					<div class="col-sm-3">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" id="Opcao" name="nOpcao"
							value="<?=$lista['opcao'];?>" placeholder="Opcao">
						</div>	
					</div>
					...
					<div class="col-sm-3">
						...
						<div class="input-group">
							...
							<select class="form-control" id="Atendimento" name="nAtendimento" >
								<option value="<?=$lista['hor_atend'];?>"><?=$lista['hor_atend'];?></option>
								<option value="">Selecione...</option>
					...
					<div class="col-sm-3">
						...
						<div class="input-group">
							...
							<select class="form-control" id="Escalonar" name="nEscalonar" >
								<option value="<?=$lista['tpa'];?>"><?=$lista['tpa'];?></option>
								<option value="">Selecione...</option>
				...
				<div class="form-group row">
					...
					<div class="col-sm-12">
						...
						<div class="input-group">
							...
							Fora do Horário Comercial</label>
						</div>	 
					</div>	
					...
					<div class="col-sm-3">
						...
						<div class="input-group">
							...
							<select class="form-control" id="NivelMinimo" name="nNivelMinimo" >
								<option value="<?=iconv("CP1252","UTF-8//TRANSLIT",$lista['niv_min']);?>"><?=$lista['niv_min'];?></option>
								<option value="">Selecione...</option>
				...
				<button type="submit" 
						...
						formaction="../CONTROLLERS/EscalonamentoController.php?opcao=Alterar"
						formtarget="_self"
						>
